...
export default function DistributorLayout() {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-dark-bg">
      {/* Sidebar - Fixed and independent scrolling */}
      <aside className="w-64 bg-dark-card border-r border-dark-border flex flex-col sticky top-0 h-screen">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        <header className="h-16 bg-dark-card border-b border-dark-border flex items-center justify-between px-6 flex-shrink-0 z-10">
